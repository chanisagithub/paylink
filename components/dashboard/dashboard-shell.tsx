...
export function DashboardShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="mx-auto grid min-h-screen w-full max-w-7xl gap-8 px-4 py-4 lg:grid-cols-[260px_minmax(0,1fr)] lg:px-6">
        <aside className="rounded-[2rem] border border-white/10 bg-[#141414] p-5 lg:sticky lg:top-4 lg:h-[calc(100vh-2rem)]">
